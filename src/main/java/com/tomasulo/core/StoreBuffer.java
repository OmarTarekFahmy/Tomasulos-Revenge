...
public class StoreBuffer {
    ...
    public int getEffectiveAddress() { return (int) effectiveAddress; }
    public State getState() { return state; }
    public boolean isFree() { return !busy; }
    public int getSrcRegIndex() { return srcRegIndex; }
    public double getValueToStore() { return valueToStore; }
